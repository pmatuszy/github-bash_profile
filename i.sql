...
col i_username head USERNAME format a12
col i_sid head SID for a5 new_value mysid
col i_serial head SERIAL# for a8 new_value _i_serial
col i_cpid head CPID for a10 new_value _i_cpid
col i_spid head SPID for a7 new_value _i_spid
col i_opid head OPID for a5 new_value _i_opid
col i_host_name head HOST_NAME for a20 new_value _i_host
col i_instance_name head INST_NAME for a10 new_value _i_inst
